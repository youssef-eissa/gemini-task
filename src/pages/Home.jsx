...
if(isLoading){
  ...
  return (
    <main className='  min-h-screen  flex items-center justify-center flex-col gap-5 '>
      <h1 className="text-mainColor text-4xl xl:text-3xl lg:text-2xl xs:text-xl font-alpha tracking-widest">Tasks Summary</h1>
      {/* todos statistics */}
     ...
     <div className="flex items-center justify-between font-alpha ">
      <span className="text-mainColor text-4xl xl:text-3xl lg:text-2xl md:text-xl xs:text-base">
        Done Tasks
      </span>
     ...
     <div className="flex items-center justify-between font-alpha">
      <span className="text-mainColor text-4xl xl:text-3xl lg:text-2xl xs:text-base">
       Total Tasks
      </span>
      <span className=" aspect-square rounded-full bg-actionColor flex items-center justify-center xl:w-20 lg:w-16 xs:w-12 xs:text-xs lg:text-sm">
         {todos?.length}
  ...
  <span className="text-subColor tracking-[6px] lg:text-lg font-bebas text-sm">Keep it up</span>
      ...
      {/* todos statistics */}
        ...
        <Link className="w-fit mx-auto flex items-center justify-center gap-2 bg-actionColor hover:bg-actionColor/90  rounded p-3 lg:p-2 md:p-2 xs:p-1 transition duration-300  font-bebas tracking-widest lg:text-xl text-base" to={"/todos"}>  <IoAddOutline/> Add New Task</Link>
